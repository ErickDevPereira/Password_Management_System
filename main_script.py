...
class Login_Window(Window):
    ...
    def call(self):
        self.register = Register_Window(args.window_size['Register'][0], args.window_size['Register'][1], 'Ico_Files/for_test.ico', 'Password Management System ErickDev',
                                        text_title = 'REGISTER AN ACCOUNT',
                                        posx_title = args.pos['Register']['title'][0], posy_title = args.pos['Register']['title'][1], color_label = args.pattern_style['main_color'], font_size_title_label = 40,
                                        font_style_label = args.pattern_style['main_font'], text_user = 'Username', posx_user = args.pos['Register']['user_label'][0], posy_user = args.pos['Register']['user_label'][1],
                                        font_size_otherwise_label = 30, entry_user_placeholder = 'Type the username here', entry_user_posx = args.pos['Register']['user_entry'][0],
                                        entry_user_posy = args.pos['Register']['user_entry'][1], color_entry = 'white', font_size_entry = 20, font_style_entry = args.pattern_style['main_font'],
                                        width_entry = 400, height_entry = 50, text_password = 'Password', posx_password = args.pos['Register']['password_label'][0], posy_password = args.pos['Register']['password_label'][1],
                                        entry_password_posx = args.pos['Register']['password_entry'][0], entry_password_posy = args.pos['Register']['password_entry'][1], entry_PW_placeholder = 'Type your password here',
                                        text_passwordC = 'Confirm Password', posx_passwordC = args.pos['Register']['passwordC_label'][0], posy_passwordC = args.pos['Register']['passwordC_label'][1], entry_passwordC_posx = args.pos['Register']['passwordC_entry'][0],
                                        entry_passwordC_posy = args.pos['Register']['passwordC_entry'][1], email = 'Email', posx_email = 0.24, posy_email = 0.61, entry_email_posy = args.pos['Register']['email_entry'][1],
                                        entry_email_posx = args.pos['Register']['email_entry'][0], entry_email_placeholder = 'Type your email here',phone_text = 'Phone Number', posx_phone = args.pos['Register']['phone_label'][0],
                                        posy_phone = args.pos['Register']['phone_label'][1], entry_phone_placeholder = 'Type your phone number here', entry_phone_posx = args.pos['Register']['phone_entry'][0], entry_phone_posy = args.pos['Register']['phone_entry'][1],
                                        pos_hide_x = args.pos['Register']['hide_label'][0], pos_hide_y = args.pos['Register']['hide_label'][1], button_text = 'REGISTER', color_of_button = args.pattern_style['main_color'], hover_color = args.pattern_style['button_hover_color'],
                                        button_width = 300, button_height = 50, font_style_button = args.pattern_style['main_font'], font_size_button = 30, button_text_color = args.pattern_style['button_label_color'],
                                        button_posx = args.pos['Register']['button'][0], button_posy = args.pos['Register']['button'][1], border_width_entry = 4, border_color_entry = args.pattern_style['main_color'], bgcolor_entry = 'black', checkbox_size = 20,
                                        error_posx = args.pos['Register']['error'][0], error_posy = args.pos['Register']['error'][1], border_w = 4, border_color = args.pattern_style['border_button_color'])
        self.register.open_window()

class Store_Window(Login_Window):

    def __init__(self, width, height, icon_path, title, id_user, **kwargs):
        super().__init__(width, height, icon_path, title, font_size_title_label = kwargs['font_size_title_label'], font_size_otherwise_label = kwargs['font_size_otherwise_label'], font_style_label = kwargs['font_style_label'],
                 text_title = kwargs['text_title'], posx_title = kwargs['posx_title'], posy_title = kwargs['posy_title'], color_label = kwargs['color_label'], text_user = kwargs['text_user'], posx_user = kwargs['posx_user'],posy_user = kwargs['posy_user'],
                 entry_user_placeholder = kwargs['entry_user_placeholder'], entry_user_posx = kwargs['entry_user_posx'], entry_user_posy = kwargs['entry_user_posy'], color_entry = kwargs['color_entry'], bgcolor_entry = kwargs['bgcolor_entry'],border_color_entry = kwargs['border_color_entry'],border_width_entry = kwargs['border_width_entry'],
                 font_style_entry = kwargs['font_style_entry'], hover_color_button = kwargs['hover_color_button'], font_size_entry = kwargs['font_size_entry'], width_entry = kwargs['width_entry'], height_entry = kwargs['height_entry'], text_password = kwargs['text_password'], posx_password = kwargs['posx_password'],
                 posy_password = kwargs['posy_password'], entry_password_posx = kwargs['entry_password_posx'], entry_password_posy = kwargs['entry_password_posy'], pos_hide_x = kwargs['pos_hide_x'],pos_hide_y = kwargs['pos_hide_y'],button_text = kwargs['button_text'],button_text_create = kwargs['button_text_create'],color_of_button = kwargs['color_of_button'],
                 button_width = kwargs['button_width'], button_height = kwargs['button_height'],font_size = kwargs['font_size'], font_style_button = kwargs['font_style_button'], button_text_color = kwargs['button_text_color'], button_posx = kwargs['button_posx'], button_posy = kwargs['button_posy'], checkbox_size = kwargs['checkbox_size'], button_posy_create = kwargs['button_posy_create'],
                 error_label_text = kwargs['error_label_text'],error_label_color = kwargs['error_label_color'], error_label_posx = kwargs['error_label_posx'], error_label_posy = kwargs['error_label_posy'], font_error = kwargs['font_error'], green_card_register = False, border_color = None, border_w = None, img1x = None, img2x = None, img2y = None, img1y = None, button_posx_create = None)
...
class Delete_Window(Show_Window):
    ...
    def __init__(self, width, height, icon_path, title, id_user, **kwargs):
        super().__init__(width, height, icon_path, title, id_user, left_button_posx = kwargs['left_button_posx'],right_button_posx = kwargs['right_button_posx'], button_posy = kwargs['button_posy'],
                        text = kwargs['text'], pattern_color = kwargs['pattern_color'], text_font_size = kwargs['text_font_size'], text_posx = kwargs['text_posx'], text_posy = kwargs['text_posy'],data_posx = None,data_posy = None, font_style = kwargs['font_style'], 
                        data_size = None, box_width = kwargs['box_width'], box_height = kwargs['box_height'], button_hover_color = kwargs['button_hover_color'], wbutton = kwargs['wbutton'], hbutton = kwargs['hbutton'], button_text_font_size = kwargs['button_text_font_size'],
                        box_posy = kwargs['box_posy'], box_posx = kwargs['box_posx'], green_card = False, border_w = None, border_color = None)
...
class Option_Window(Window):
    ...
    def store(self):
        self.store_window = Store_Window(args.window_size['Store'][0], args.window_size['Store'][1], 'Ico_Files/for_test.ico', 'Password Management System ErickDev', self.id_user,
                                         font_size_title_label = 60, font_size_otherwise_label = 30, font_style_label = args.pattern_style['main_font'],
                                         text_title = 'STORE', posx_title = args.pos['Store']['title'][0], posy_title = args.pos['Store']['title'][1], color_label = args.pattern_style['main_color'], text_user = 'Username', posx_user = args.pos['Store']['user_label'][0], posy_user = args.pos['Store']['user_label'][1],
                                         entry_user_placeholder = 'Type your username here', entry_user_posx = args.pos['Store']['user_entry'][0], entry_user_posy = args.pos['Store']['user_entry'][1], color_entry = 'white', bgcolor_entry = 'black', border_color_entry = args.pattern_style['main_color'], border_width_entry = 4,
                                         font_style_entry = args.pattern_style['main_font'],hover_color_button = args.pattern_style['button_hover_color'], font_size_entry = 20, width_entry = 400, height_entry = 50,text_password = 'Password', posx_password = args.pos['Store']['password_label'][0],
                                         posy_password = args.pos['Store']['password_label'][1], entry_password_posx = args.pos['Store']['password_entry'][0], entry_password_posy = args.pos['Store']['password_entry'][1], pos_hide_x = args.pos['Store']['hide'][0], pos_hide_y = args.pos['Store']['hide'][1], button_text = 'SUBMIT', button_text_create = 'CREATE ACCOUNT', color_of_button = args.pattern_style['main_color'],
                                         button_width = 332, button_height = 50, font_size = 40, font_style_button = args.pattern_style['main_font'], button_text_color = args.pattern_style['button_label_color'], button_posx = args.pos['Store']['button'][0], button_posy = args.pos['Store']['button'][1], checkbox_size = 20, button_posy_create = None,
                                         error_label_text = '', error_label_color = args.pattern_style['error_color'], error_label_posx = args.pos['Store']['error'][0], error_label_posy = args.pos['Store']['error'][1], font_error = 20,  text_plat = 'Platform', posx_plat = args.pos['Store']['platform_label'][0], posy_plat = args.pos['Store']['platform_label'][0], entry_plat_posx = args.pos['Store']['platform_entry'][0], entry_plat_posy = args.pos['Store']['platform_entry'][1])
        self.store_window.open_window()
        
    def access(self):
        self.show_window = Show_Window(args.window_size['Show'][0], args.window_size['Show'][1], 'Ico_Files/for_test.ico', 'Password Management System ErickDev', id_user = self.id_user,
                                       left_button_posx = args.pos['Show']['left_button'][0], right_button_posx = args.pos['Show']['right_button'][0], button_posy = args.pos['Show']['left_button'][1],
                                       text = 'CHOOSE AN OPTION', pattern_color = args.pattern_style['main_color'], text_font_size = 40, text_posx = args.pos['Show']['title'][0], text_posy = args.pos['Show']['title'][1], data_posx = args.pos['Show']['data'][0],
                                       data_posy = args.pos['Show']['data'][1], font_style = args.pattern_style['main_font'], data_size = 15, box_width = 400, box_height = 400, button_hover_color = args.pattern_style['button_hover_color'],
                                       wbutton = 100, hbutton = 50, button_text_font_size = 20, box_posy = args.pos['Show']['box'][1], box_posx = args.pos['Show']['box'][0], green_card = True, border_w = 4, border_color = args.pattern_style['border_button_color'])
        self.show_window.open_window()

    def delete_data(self):
        self.delete_window = Delete_Window(args.window_size['Delete'][0], args.window_size['Delete'][1], 'Ico_Files/for_test.ico', 'Password Management System ErickDev', id_user = self.id_user,
                                           left_button_posx = args.pos['Delete']['left_button'][0], right_button_posx = args.pos['Delete']['right_button'][0], button_posy = args.pos['Delete']['right_button'][1],
                                           text = 'CHOOSE AN OPTION', pattern_color = args.pattern_style['main_color'], text_font_size = 40, text_posx = args.pos['Delete']['text'][0], text_posy = args.pos['Delete']['text'][1],
                                           font_style = args.pattern_style['main_font'], box_width = 400, box_height = 400,
                                           button_hover_color = args.pattern_style['button_hover_color'], wbutton = 100, hbutton = 50, button_text_font_size = 20, box_posy = args.pos['Delete']['box'][1],
                                           box_posx = args.pos['Delete']['box'][0], delx = args.pos['Delete']['del'][0], dely = args.pos['Delete']['del'][1], msg_x = args.pos['Delete']['msg'][0], msg_y = args.pos['Delete']['msg'][1], att_x = args.pos['Delete']['att'][0], att_y = args.pos['Delete']['att'][1], del_width = 100, del_height = 50,
                                           msg_text = "Be careful, once you've\n deleted a set of data, you\n won't be able to recover it", border_w = 4, border_color = args.pattern_style['border_button_color'], final_position_del_y = args.pos['Delete']['final_position_del_y'], final_position_box_y = args.pos['Delete']['final_position_box_y'])
...
if __name__ == '__main__':
    if SQL_CRUD.connected():
        login = Login_Window(args.window_size['Login'][0], args.window_size['Login'][1], 'Ico_Files/for_test.ico', 'Password Management System ErickDev',
                             font_size_title_label = 60, font_size_otherwise_label = 30, font_style_label = args.pattern_style['main_font'],
                             text_title = 'WELCOME', posx_title = args.pos['Login']['title'][0], posy_title = args.pos['Login']['title'][1], color_label = args.pattern_style['main_color'], text_user = 'Username', posx_user = args.pos['Login']['user_label'][0], posy_user = args.pos['Login']['user_label'][1],
                             entry_user_placeholder = 'Type your username here', entry_user_posx = args.pos['Login']['user_entry'][0], entry_user_posy = args.pos['Login']['user_entry'][1], color_entry = 'white', bgcolor_entry = 'black', border_color_entry = args.pattern_style['main_color'], border_width_entry = 4,
                             font_style_entry = args.pattern_style['main_font'],hover_color_button = args.pattern_style['button_hover_color'], font_size_entry = 20, width_entry = 400, height_entry = 50,text_password = 'Password', posx_password = args.pos['Login']['password_label'][0],
                             posy_password = args.pos['Login']['password_label'][1], entry_password_posx = args.pos['Login']['password_entry'][0], entry_password_posy = args.pos['Login']['password_entry'][1], pos_hide_x = args.pos['Login']['hide_box'][0], pos_hide_y = args.pos['Login']['hide_box'][1], button_text = 'SUBMIT', button_text_create = 'CREATE ACCOUNT', color_of_button = args.pattern_style['main_color'],
                             button_width = 332, button_height = 50, font_size = 40, font_style_button = args.pattern_style['main_font'], button_text_color = args.pattern_style['button_label_color'], button_posx = args.pos['Login']['login_button'][0], button_posy = args.pos['Login']['login_button'][1], checkbox_size = 20, button_posy_create = args.pos['Login']['create_button'][1],
                             button_posx_create = args.pos['Login']['create_button'][0], error_label_text = '', error_label_color = args.pattern_style['error_color'], error_label_posx = args.pos['Login']['error_label'][0], error_label_posy = args.pos['Login']['error_label'][1], font_error = 20, green_card_register = True, border_w = 4, border_color = args.pattern_style['border_button_color'], img1x = args.pos['Login']['img1'][0], img1y = args.pos['Login']['img1'][1], img2x = args.pos['Login']['img2'][0], img2y = args.pos['Login']['img2'][1])
        login.open_window()
        if Login_Window.green_card_login:
            option = Option_Window(args.window_size['Option'][0], args.window_size['Option'][1], 'Ico_Files/for_test.ico', 'Password Management System ErickDev', Login_Window.id_user,
                                   text = 'CHOOSE AN OPTION', posx_label = args.pos['Option']['title'][0], posy_label = args.pos['Option']['title'][1], posx_button1 = args.pos['Option']['button1'][0], posy_button1 = args.pos['Option']['button1'][1], posx_button2 = args.pos['Option']['button2'][0], posy_button2 = args.pos['Option']['button2'][1], posx_button3 = args.pos['Option']['button3'][0], posy_button3 = args.pos['Option']['button3'][1],
                                   posx_button4 = args.pos['Option']['button4'][0], posy_button4 = args.pos['Option']['button4'][1], font_size_label = 40, width_button = 300, height_button = 50, button_text_color = args.pattern_style['button_label_color'],
                                   pattern_color = args.pattern_style['main_color'], hover_color = args.pattern_style['button_hover_color'], font_size = 30, font_style = args.pattern_style['main_font'], border_w = 4, border_color = args.pattern_style['border_button_color'], posx_button5 = args.pos['Option']['button5'][0], posy_button5 = args.pos['Option']['button5'][1])
            option.open_window()
    else:
        cnct_error = Error_Window(args.window_size['Error'][0], args.window_size['Error'][1], 'Ico_Files/for_test.ico', 'PMS connection error', "ERROR: CAN'T CONNECT TO THE DATABASE",
                                  pos_x_button = args.pos['Error']['button'][0], pos_y_button = args.pos['Error']['button'][1], pos_x_label = args.pos['Error']['label'][0], pos_y_label = args.pos['Error']['label'][1],border_w = 4,
                                  border_color = args.pattern_style['border_button_color'], img1x = args.pos['Error']['img1'][0], img1y = args.pos['Error']['img1'][1],
